<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageQuizzes.aspx.cs" Inherits="OnlineQuizApp.Admin.ManageQuizzes" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Quizzes - OnlineQuizApp</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="top-header">
            <div class="container d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="page-subtitle">View and manage all created quizzes in the system</div>
                </div>
                <div>
        ...
        <div class="container">
            <div class="content-card">
                ...
                <div class="info-box">
                    <strong>Admin Note:</strong> This page displays all quizzes created in the system with total questions, total marks, creator, and created date.
                </div>
            ...
            <div class="footer-note">
                OnlineQuizApp Quiz Management Panel | Developed by Khitish Ranjan Jena
            </div>
        </div>
